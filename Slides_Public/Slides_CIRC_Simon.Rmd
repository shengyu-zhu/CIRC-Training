...
The syllabus and slides are publicly available at [this GitHub repository](https://github.com/zhus1994/CIRC-Training)

There is another 24-page PDF file containing the slides about the detailed connection info
...
Please open your laptop and connect to WiFi. 
- CIRC can only be accessed using the interal internet of UR
  - Please connect to UR_Connected (recommended) or UR_RC_InternalSecure
...
- For data >100G, better to connect to data that exists outside of R, use Spark
...
2. upload big data set to BlueHive, take a subsample and download that to local desktop

2. write code locally to analyze subsample data and transfer code to BlueHive

2. Test your code can run on subsample data on BlueHive
...
> **upload big data set to BlueHive, take a subsample and download that to local desktop**
> **write code locally to analyze data and transfer code to BlueHive**
...
```
> **Test your code can run on subsample data on BlueHive**

---
# Separate result using subsample
The Diamond project don't involve subsampling now
- I will just provide some code that may help

Use `if` to load different data at the beginning of the script
```{r eval=FALSE}
	SystemsInfo <- Sys.info()['sysname']
	if(unname(SystemsInfo)=="Linux"){Dimamonds <- 
	  readRDS("../temp/FULLData.rds")}
	if(unname(SystemsInfo)=="Windows"){Dimamonds <- 
	  readRDS("../temp/Subsample.rds")}
```

This code will save plots based on subsample and whole sample separately
```{r eval=FALSE}
if(unname(SystemsInfo)=="Linux")	ggsave("../output/figure/FIGURE.jpeg", dpi = 500)
if(unname(SystemsInfo)=="Linux")    ggsave("../output/figure/FIGURE.pdf", width=8, height=5)
if(unname(SystemsInfo)=="Windows")	ggsave("../output/figure/FIGURE_Sub.jpeg", dpi = 500)
if(unname(SystemsInfo)=="Windows")  ggsave("../output/figure/FIGURE_Sub.pdf", width=8, height=5)
```
...
What if you have >500G, 1TB data?

Storage: contact CIRC by short-period storage limit increase, specify reason/time/storage

Analyze: Apache Spark is one analysis engine that can help, which is available on BlueHive

In Rstudio: Use sparklyr to access & analyze the data inside Spark.
Only bring results into R.

<div align="center">
<img src="pics/SparklyR.png" style="width: 100%">
</div>


Source: https://conferences.oreilly.com/strata/strata-ca-2017/public/schedule/detail/55800
---
# sparklyr


<div align="center">
<img src="pics/RstudioInterface.png" style="width: 100%">
</div>
Source: https://conferences.oreilly.com/strata/strata-ca-2017/public/schedule/detail/55800
...
<div align="center">
<img src="pics/Deployment.png" style="width: 100%">
</div>
Source: https://conferences.oreilly.com/strata/strata-ca-2017/public/schedule/detail/55800
...
<div align="center">
<img src="pics/SparkDeploy.png" style="width: 100%">
</div>
Source: https://conferences.oreilly.com/strata/strata-ca-2017/public/schedule/detail/55800
- More on Spark: https://spark.apache.org/
- More on sparklyr: https://spark.rstudio.com/
---
class: inverse, center, middle
